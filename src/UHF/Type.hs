...
typecheck :: (DeclArena, UntypedNominalTypeArena, UntypedBindingArena, UntypedBoundNameArena) -> Compiler.Compiler (DeclArena, TypedNominalTypeArena, TypedBindingArena, TypedBoundNameArena)
