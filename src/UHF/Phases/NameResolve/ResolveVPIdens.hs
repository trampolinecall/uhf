...
resolve sir_child_maps (SIR.SIR decls mods adts type_synonyms type_vars bound_values mod) =
    runStateT
        (
            runReaderT (resolve_in_mods mods) (adts, bound_values, (), sir_child_maps) >>= \ mods ->
...
resolve_in_mods :: UnresolvedModuleArena -> (Utils.NRReader UnresolvedADTArena UnresolvedBoundValueArena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) ResolvedModuleArena
resolve_in_mods = Arena.transformM resolve_in_module

resolve_in_adts :: UnresolvedADTArena -> (Utils.NRReader adt_arena bv_arena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) ResolvedADTArena
resolve_in_adts = Arena.transformM resolve_in_adt

resolve_in_type_synonyms :: UnresolvedTypeSynonymArena -> (Utils.NRReader adt_arena bv_arena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) ResolvedTypeSynonymArena
resolve_in_type_synonyms = Arena.transformM resolve_in_type_synonym

resolve_in_module :: SIR.Module Unresolved -> Utils.NRReader UnresolvedADTArena UnresolvedBoundValueArena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors) (SIR.Module Resolved)
...
resolve_in_adt :: UnresolvedADT -> (Utils.NRReader adt_arena bv_arena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) ResolvedADT
...
resolve_in_type_synonym :: UnresolvedTypeSynonym -> (Utils.NRReader adt_arena bv_arena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) ResolvedTypeSynonym
...
resolve_in_binding :: SIR.Binding Unresolved -> (Utils.NRReader UnresolvedADTArena UnresolvedBoundValueArena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) (SIR.Binding Resolved)
...
resolve_in_type_expr :: SIR.TypeExpr Unresolved -> (Utils.NRReader adt_arena bv_arena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) (SIR.TypeExpr Resolved)
...
resolve_in_pat :: SIR.Pattern Unresolved -> (Utils.NRReader adt_arena bv_arena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) (SIR.Pattern Resolved)
...
resolve_in_expr :: SIR.Expr Unresolved -> (Utils.NRReader UnresolvedADTArena UnresolvedBoundValueArena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors)) (SIR.Expr Resolved)
...
resolve_split_iden :: SIR.SplitIdentifier Unresolved start -> Utils.NRReader adt_arena bv_arena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState Utils.WithErrors) (SIR.SplitIdentifier Resolved start)
...
-- TODO: remove this?
resolve_iden_in_monad :: Monad under => (Utils.DeclArena -> Utils.SIRChildMaps -> iden -> under resolved) -> iden -> Utils.NRReader adt_arena bv_arena type_var_arena Utils.SIRChildMaps (Utils.MakeDeclState under) resolved
resolve_iden_in_monad f iden =
    lift get >>= \ decls ->
    Utils.ask_sir_child_maps >>= \ sir_child_maps ->
    lift (lift $ f decls sir_child_maps iden)

-- TODO: factor out repeated code?
resolve_expr_iden :: Utils.DeclArena -> Utils.SIRChildMaps -> UnresolvedVIden -> Utils.WithErrors ResolvedVIden
resolve_expr_iden decls sir_child_maps (SIR.SplitIdentifier'Get type_part name) =
    case Utils.get_value_child decls sir_child_maps <$> SIR.type_expr_evaled type_part <*> pure name of
...
resolve_pat_iden :: Utils.DeclArena -> Utils.SIRChildMaps -> UnresolvedPIden -> Utils.WithErrors ResolvedPIden
resolve_pat_iden decls sir_child_maps (SIR.SplitIdentifier'Get type_part name) =
    case Utils.get_variant_child decls sir_child_maps <$> SIR.type_expr_evaled type_part <*> pure name of
        Just (Right v) -> pure $ Just v
        Just (Left e) -> Compiler.tell_error e >> pure Nothing
        Nothing -> pure Nothing
