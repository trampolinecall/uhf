...
type AllHaveInstance c s = (c (DIden s), c (VIden s), c (PIden s), c (TypeExprTypeInfo s), c (TypeInfo s), c (BinaryOpsAllowed s))
type AllShowable s = (Show (DIden s), Show (VIden s), Show (PIden s), Show (TypeExprTypeInfo s), Show (TypeInfo s), Show (BinaryOpsAllowed s))
