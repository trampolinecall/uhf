...
compile :: File -> Either [Diagnostic.Error] (Maybe NoPoisonIR)
compile file =
...
compile' :: File -> ErrorAccumulated (Maybe NoPoisonIR)
compile' file =
    ...
    in pure $ RemovePoison.remove_poison (decls, nominal_types, nodes, params, bound_values)
